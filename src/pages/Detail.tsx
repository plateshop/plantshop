                    ...
                    <div className='detail_container_menu'>
                        <div className='detail_container_menu_fixbox'>
                            <div className='detail_container_info'>
                                <h4 className='info_title'>D11 머그 민트마블f</h4>
                                <div className='info_wrap'>
                                    <p className='info_wrap_price'>
                                        "20,000"
                                        "원"
                                    </p>
                                    <span className='info_wrap_like'>하트가 올자리
                                        <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" color="black" height="27" width="27" xmlns="http://www.w3.org/2000/svg" ><title>찜</title><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                                    </span>
                                </div>
